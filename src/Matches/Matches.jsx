...
function Matches(props) {
  ...
  return (
    ...
    <ul class="list-none mx-auto mt-10 flex flex-col sm:flex-row items-center gap-12">
        ...
        <li onClick={()=>{props.isHome? navigate("/UserScrimList"): null }}  class="w-1/3 h-80 justify-center sm:w-5/6  flex flex-col items-center border rounded-md border-solid border-orange-500 hover:border-blue-500 hover:cursor-pointer">
        ...
        <li onClick={()=>{props.isHome? navigate("/UserDailyMatch"): null }} class="w-1/3 h-80 justify-center sm:w-5/6  flex flex-col items-center border rounded-md border-solid border-orange-500 hover:border-blue-500 hover:cursor-pointer">
            <h3 class="text-2xl text-center mt-2 text-orange-500 "><a href='#'>DAILY MATCH</a></h3> 
        </li>
        <li onClick={()=>{props.isHome? navigate("/UserOpenRoom"): null }} class="w-1/3 h-80 justify-center sm:w-5/6  flex flex-col items-center border rounded-md border-solid border-orange-500 hover:border-blue-500 hover:cursor-pointer">
