    ...
    <div>
      ...
      <div className={classes.formDiv}>
        <form className="flex flex-col w-[40%] mx-auto bg-transparent" onSubmit={handleSubmit}>
          ...
          <textarea className="bg-gray-800/80 h-52 mb-14 px-4 py-4 text-[#ff8a01] placeholder:text-[#ff8a01]" type="text" id="rules" value={DailyMatchrules} placeholder="Rules" onChange={(e)=>setDailyMatchRules(e.target.value)}/>
